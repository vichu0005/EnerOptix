          ...
          <nav className="hidden md:flex items-center gap-1">
            <button 
              ...
              className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg transition-all ${
                activeTab === 'dashboard' ? 'text-[#10b981] bg-[#10b981]/10' : 'text-slate-400 hover:text-white'
              }`}
            >
            ...
            <button 
              ...
              className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg transition-all ${
                activeTab === 'insights' ? 'text-[#10b981] bg-[#10b981]/10' : 'text-slate-400 hover:text-white'
              }`}
            >
              <Lightbulb size={18} />
              Insights
            ...
            <button 
              ...
              className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg transition-all ${
                activeTab === 'reports' ? 'text-[#10b981] bg-[#10b981]/10' : 'text-slate-400 hover:text-white'
              }`}
            >
              <FileText size={18} />
              Reports
        ...
        <div className="hidden lg:flex items-center gap-4 bg-[#0f172a] p-1 rounded-xl border border-slate-800">
           <button 
             ...
             className={`flex items-center gap-2 px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-wider transition-all duration-300 ${
               mode === 'live' ? 'bg-[#10b981] text-[#060b13]' : 'text-slate-500 hover:text-slate-300'
             }`}
           >
             <Activity size={12} />
             Live View
           ...
           <button 
             ...
             className={`flex items-center gap-2 px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-wider transition-all duration-300 ${
               mode === 'static' ? 'bg-[#10b981] text-[#060b13]' : 'text-slate-500 hover:text-slate-300'
             }`}
           >
             <Database size={12} />
             Historical
